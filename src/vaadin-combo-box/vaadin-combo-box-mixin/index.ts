...
import { IronA11yAnnouncer as PolymerIronA11yAnnouncer } from '@polymer/iron-a11y-announcer/iron-a11y-announcer';
...
const VaadinComboBoxMixinElement = subclass =>
class _VaadinComboBoxMixinElement extends subclass {
  ...
  ready() {
    ...
    PolymerIronA11yAnnouncer.requestAvailability();
  ...
  _isEventKey(e, k) {
    return PolymerIronA11yKeysBehavior.keyboardEventMatchesKeys(e, k);
  }
  _getItemLabel(item) {
  ...
  _ensureTemplatized() {
    if (!this._TemplateClass) {
      ...
      if (tpl) {
        this._TemplateClass = PolymerTemplatize.templatize(tpl, this, {
...
export default VaadinComboBoxMixinElement;
